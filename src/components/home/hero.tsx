  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex items-center gap-6 pt-4">
        <a href="mailto:nodirbekgolang@gmail.com" className="bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-300 flex items-center gap-2 px-6 py-3 rounded-full text-sm text-white hover:scale-105">
          <Mail size={14} />
        ...
        <div className="flex items-center gap-4 px-2">
          ...
          <a href="https://t.me/nodirbek" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition-colors"><Send size={20} /></a>
        </div>
      </div>
    </div>
  )
