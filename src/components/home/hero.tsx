  ...
  return (
    <div className="space-y-10">
      <motion.h1
        ...
        className="text-5xl md:text-7xl text-white leading-[1.05] tracking-tight"
      >
      ...
      <motion.div
        ...
        className="space-y-6 text-sm md:text-base text-zinc-400 leading-relaxed max-w-md font-light"
      >
        <p>
